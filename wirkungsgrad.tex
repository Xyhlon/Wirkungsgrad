...
\begin{table}[H]
	\caption{}\label{tab:werte_serienschaltung}
	\centering
...
\begin{table}[H]
	\caption{}\label{tab:werte_parallelschaltung}
	\centering
...
\begin{table}[H]
	\caption{}\label{tab:werte_abgedeckt}
	\centering
...
\begin{figure}[H]
	...
	\caption{}\label{fig:mess_dunkelkennlinie}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{}\label{fig:mess_hellkennlinie_lampe}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{figures/helllampe2.png}
	\caption{}\label{fig:mess_hellkennlinie_lampe2}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{figures/hellled.png}
	\caption{}\label{fig:mess_hellkennlinie_led}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{figures/pressureProfile.pdf}
	\includegraphics[width=0.95\textwidth]{figures/temperatureProfile.pdf}
