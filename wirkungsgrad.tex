...
%todo i hoffe da is ka fehler mit de figures
\begin{figure}[H]
	\centering
	\captionbox{Versuchsaufbau der Wärmepumpe, am Bild markiert  sind die Kanäle, mit denen die entsprechenden
		Temperatursensoren verbunden sind
		\label{fig:warmepumpe}}{
		\includegraphics[width=.45\textwidth]{./figures/warmepumpe_anschlusse.png}
	}
	\hfill
	\captionbox{Skizze des Versuchsaufbaus der Wärmepumpe \cite[text]{unterlagen_warmepumpe} \\
		...
		Anklemmen an Kupferrohre 12 \dots Kupfer-Meßschuh (2x) zum Einstecken von
		Temperaturfühlern für Temperaturmessungen an den Kupferrohren des
		Kältemittelkreislaufs 13 \dots Manometer für die Niederdruckseite; innere Skala
		...
		bis + 85°C. \label{fig:skizze_warmepumpe}}{
...
Aufzeichnung der Daten über den entsprechenden Knopf gestartet. Zusätzlich zur
