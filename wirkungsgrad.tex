...
\begin{figure}[H]
	...
	\end{center}
	\caption{Versuchsaufbau der Wärmepumpe, am Bild markiert  sind die Kanäle, mit denen die entsprechenden
...
\begin{figure}[H]
	...
	\end{center}
	\caption{Skizze des Versuchsaufbaus der Wärmepumpe \cite[text]{unterlagen_warmepumpe} \\
...
\begin{figure}[H]
	...
	\end{center}
	\caption{Schaltplan der Solarzelle \cite{unterlagen_solarzelle}\\
	A \dots Amperemeter\\
	V \dots Voltmeter
...
\begin{figure}[H]
	\centering
	\captionbox{Serienschaltung der beiden Solarzellen\\
	...
	\hfill
	\captionbox{Parallelschaltung der beiden Solarzellen \\
	1 \dots Solarzellenmodule\\
	2 \dots Lampe\\
	3 \dots regelbarer Widerstand\\
	4 \dots Voltmeter\\
