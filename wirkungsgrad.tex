...
\begin{figure}[H]
	...
	\end{center}
	\caption[Schaltplan der Solarzelle]{Schaltplan der Solarzelle
		\cite{unterlagen_solarzelle} \\
		A \dots Amperemeter          \\
		V \dots Voltmeter
...
höhenverstellbare Halogenlampe, sowie eine LED Beleuchtung verwendet. Bei der
...
Zusätzlich zur Temperaturmessung werden ca. im 2 Minuten- Takt die Drücke von
den entsprechenden Barometern abgelesen, was in folgender \autoref{tab:drucke}
...
Abstand zwischen diesen bestimmt. Dieser beträgt \SI{28.0(5)}{\cm}. Die
...
\autoref{tab:grose_solarzelle} beigefügt.
...
Parameter, wie zb den Maximalen Strom, wie in den Unterlagen aus
